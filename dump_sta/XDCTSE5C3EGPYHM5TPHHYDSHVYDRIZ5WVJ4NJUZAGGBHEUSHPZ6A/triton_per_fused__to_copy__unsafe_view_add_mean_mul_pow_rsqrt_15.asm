...
.Lfunc_begin0:
	.file	1 "/home/chlee/qwen_triton_engine/rebuilt_kernels" "k135114294089120.py"
	.loc	1 2 0                           # k135114294089120.py:2:0
...
# %bb.0:
	...
	sext.w	a5, a6
.Ltmp0:
	.loc	1 18 41 prologue_end            # k135114294089120.py:18:41
	slli	a7, a6, 7
	slli	t0, a6, 10
	li	a4, 64
	.loc	1 10 21                         # k135114294089120.py:10:21
	slti	a6, a5, 14
	.loc	1 18 41                         # k135114294089120.py:18:41
	subw	a5, t0, a7
	.loc	1 18 46 is_stmt 0               # k135114294089120.py:18:46
	vsetvli	zero, a4, e16, m8, ta, ma
	vmv.v.i	v8, 0
	.loc	1 18 30                         # k135114294089120.py:18:30
	slli	a5, a5, 1
	.loc	1 18 46                         # k135114294089120.py:18:46
	...
	vle16.v	v16, (a0), v0.t
	li	a0, 32
	.loc	1 18 108                        # k135114294089120.py:18:108
	...
	addi	a7, a7, 768
	vmv8r.v	v16, v8
	vsetvli	zero, a4, e16, m8, ta, mu
	vle16.v	v16, (a7), v0.t
	.loc	1 19 30 is_stmt 1               # k135114294089120.py:19:30
	add	a1, a1, a5
	.loc	1 19 46 is_stmt 0               # k135114294089120.py:19:46
	addi	a7, a1, 384
	vmv8r.v	v24, v8
	vle16.v	v24, (a7), v0.t
	csrr	a7, vlenb
	...
	addi	a1, a1, 768
	vle16.v	v8, (a1), v0.t
	.loc	1 18 108 is_stmt 1              # k135114294089120.py:18:108
	vsetvli	zero, a0, e32, m8, ta, ma
	vzext.vf2	v0, v16
	csrr	a1, vlenb
	li	a7, 353
	...
	.loc	1 19 108                        # k135114294089120.py:19:108
	vsetvli	zero, a0, e32, m8, ta, ma
	vzext.vf2	v16, v24
	vsetvli	zero, a0, e16, m8, ta, ma
	...
	vzext.vf2	v0, v24
	vsll.vi	v0, v0, 16
	.loc	1 21 18                         # k135114294089120.py:21:18
	vfadd.vv	v8, v8, v0
	csrr	a1, vlenb
	li	a7, 329
	mul	a1, a1, a7
	...
	addi	a1, a1, 16
	vs8r.v	v8, (a1)                        # vscale x 64-byte Folded Spill
	.loc	1 25 43                         # k135114294089120.py:25:43
	...
	addi	a1, a1, 16
	vs8r.v	v16, (a1)                       # vscale x 64-byte Folded Spill
	.loc	1 23 18                         # k135114294089120.py:23:18
	vmv.v.i	v24, 0
	csrr	a1, vlenb
	li	a6, 353
	mul	a1, a1, a6
...
.Ltmp1:
	...
	.loc	2 263 15                        # standard.py:263:15 @[ standard.py:293:36 @[ k135114294089120.py:26:24 ] ]
	vfadd.vv	v8, v16, v24
	csrr	a1, vlenb
	li	a6, 48
	mul	a1, a1, a6
...
.Ltmp23:
	...
	vfadd.vv	v8, v8, v16
.Ltmp24:
	.loc	2 293 36                        # standard.py:293:36 @[ k135114294089120.py:26:24 ]
...
.Ltmp31:
	...
	vfadd.vv	v8, v8, v16
.Ltmp32:
	.loc	1 26 27                         # k135114294089120.py:26:27
	...
	lui	a1, 280064
	fmv.w.x	fa5, a1
	.loc	1 28 20                         # k135114294089120.py:28:20
	vfdiv.vf	v8, v8, fa5
	lui	a1, 219235
	addi	a1, a1, 1981
	fmv.w.x	fa5, a1
	.loc	1 30 20                         # k135114294089120.py:30:20
	vfadd.vf	v8, v8, fa5
	.loc	1 31 28                         # k135114294089120.py:31:28
	vfsqrt.v	v8, v8
	.loc	1 32 19                         # k135114294089120.py:32:19
	vfmv.f.s	fa5, v8
	lui	a1, 260096
	fmv.w.x	fa4, a1
	fdiv.s	fa5, fa4, fa5
	.loc	1 20 37                         # k135114294089120.py:20:37
	addi	a1, a2, 1664
	vsetvli	zero, a4, e16, m8, ta, ma
	vle16.v	v8, (a1)
	.loc	1 20 90 is_stmt 0               # k135114294089120.py:20:90
	vsetvli	zero, a0, e32, m8, ta, ma
	vzext.vf2	v16, v8
	vsll.vi	v16, v16, 16
	csrr	a1, vlenb
	...
	addi	a1, a1, 16
	vl8r.v	v24, (a1)                       # vscale x 64-byte Folded Reload
	.loc	1 32 19 is_stmt 1               # k135114294089120.py:32:19
	vfmul.vf	v24, v24, fa5
	.loc	1 34 19                         # k135114294089120.py:34:19
	vfmul.vv	v16, v24, v16
	.loc	1 20 90                         # k135114294089120.py:20:90
	vsetvli	zero, a0, e16, m8, ta, ma
	vslidedown.vx	v8, v8, a0
	vsetvli	zero, a0, e32, m8, ta, ma
	vzext.vf2	v24, v8
	...
	.loc	1 34 19                         # k135114294089120.py:34:19
	vfmul.vv	v8, v24, v8
	.loc	1 35 48                         # k135114294089120.py:35:48
	...
	addi	s0, a2, 1408
	addi	s1, a2, 1536
	.loc	1 35 25                         # k135114294089120.py:35:25
	add	a3, a3, a5
	.loc	1 35 48 is_stmt 0               # k135114294089120.py:35:48
	addi	a5, a3, 1664
	.loc	1 20 37 is_stmt 1               # k135114294089120.py:20:37
	vle16.v	v16, (a2)
	csrr	a2, vlenb
	...
	vslideup.vx	v16, v24, a0
	vse16.v	v16, (a3), v0.t
	.loc	1 35 4 epilogue_begin is_stmt 0 # k135114294089120.py:35:4
	csrr	a0, vlenb
	li	a1, 385
	mul	a0, a0, a1
	add	sp, sp, a0
...
.Linfo_string1:
	.asciz	"k135114294089120.py"           # string offset=7 ; k135114294089120.py
.Linfo_string2:
