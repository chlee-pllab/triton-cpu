	...
	.text
	.globl	triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9 # -- Begin function triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9
	.p2align	2
	.type	triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9,@function
triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9: # @triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9
.Lfunc_begin0:
	.file	1 "/home/chlee/qwen_triton_engine/rebuilt_kernels" "k135114294390320.py"
	.loc	1 2 0                           # k135114294390320.py:2:0
...
.Ltmp0:
	.loc	1 4 33 prologue_end             # k135114294390320.py:4:33
	slliw	a2, a3, 10
	lui	a3, 1048574
	lui	a4, 599186
	.loc	1 7 19                          # k135114294390320.py:7:19
	sraiw	a5, a2, 31
	addi	a4, a4, 1171
	.loc	1 11 25                         # k135114294390320.py:11:25
	slli	a6, a2, 1
	.loc	1 7 19                          # k135114294390320.py:7:19
	srliw	a5, a5, 19
	.loc	1 10 47                         # k135114294390320.py:10:47
	mul	a4, a2, a4
	.loc	1 11 25                         # k135114294390320.py:11:25
	add	a1, a1, a6
	.loc	1 7 19                          # k135114294390320.py:7:19
	...
	sraiw	a4, a4, 15
	add	a3, a4, a3
	.loc	1 10 41 is_stmt 0               # k135114294390320.py:10:41
	slli	a3, a3, 13
	.loc	1 10 35                         # k135114294390320.py:10:35
	addw	a2, a3, a2
	.loc	1 10 30                         # k135114294390320.py:10:30
	slli	a2, a2, 1
	add	a0, a0, a2
	.loc	1 10 52                         # k135114294390320.py:10:52
	lh	a2, 0(a0)
	lui	a3, 2
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 144(a3)                     # 8-byte Folded Spill
	lh	a2, 514(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 128(a3)                     # 8-byte Folded Spill
	lh	a2, 518(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 112(a3)                     # 8-byte Folded Spill
	lh	a2, 522(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 104(a3)                     # 8-byte Folded Spill
	lh	a2, 524(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 96(a3)                      # 8-byte Folded Spill
	lh	a2, 526(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 88(a3)                      # 8-byte Folded Spill
	lh	a2, 528(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 72(a3)                      # 8-byte Folded Spill
	lh	a2, 532(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 56(a3)                      # 8-byte Folded Spill
	lh	a2, 536(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 48(a3)                      # 8-byte Folded Spill
	lh	a2, 538(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 40(a3)                      # 8-byte Folded Spill
	lh	a2, 540(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 24(a3)                      # 8-byte Folded Spill
	lh	a2, 544(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 16(a3)                      # 8-byte Folded Spill
	lh	a2, 546(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, 0(a3)                       # 8-byte Folded Spill
	lh	a2, 550(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -8(a3)                      # 8-byte Folded Spill
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -152(a3)                    # 8-byte Folded Spill
	lh	a2, 588(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -160(a3)                    # 8-byte Folded Spill
	lh	a2, 590(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -176(a3)                    # 8-byte Folded Spill
	lh	a2, 594(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -184(a3)                    # 8-byte Folded Spill
	lh	a2, 596(a0)
	lui	a3, 1
	add	a3, sp, a3
	sd	a2, -192(a3)                    # 8-byte Folded Spill
	lh	a2, 598(a0)
	lui	a3, 1
	add	a3, sp, a3
	...
	lh	a3, 2030(a0)
	lh	a0, 2032(a0)
	.loc	1 11 36 is_stmt 1               # k135114294390320.py:11:36
	sh	a2, 2046(a1)
	lui	a2, 1
	add	a2, sp, a2
	ld	a2, -1664(a2)                   # 8-byte Folded Reload
	sh	a2, 2038(a1)
	sh	a5, 2040(a1)
	sh	a6, 2042(a1)
	sh	a4, 2044(a1)
	...
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 144(a0)                     # 8-byte Folded Reload
	sh	a0, 512(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 136(a0)                     # 8-byte Folded Reload
	sh	a0, 514(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 128(a0)                     # 8-byte Folded Reload
	sh	a0, 516(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 120(a0)                     # 8-byte Folded Reload
	sh	a0, 518(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 112(a0)                     # 8-byte Folded Reload
	sh	a0, 520(a1)
	lui	a0, 1
	add	a0, sp, a0
	...
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 96(a0)                      # 8-byte Folded Reload
	sh	a0, 524(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 88(a0)                      # 8-byte Folded Reload
	sh	a0, 526(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 80(a0)                      # 8-byte Folded Reload
	sh	a0, 528(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 72(a0)                      # 8-byte Folded Reload
	sh	a0, 530(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 64(a0)                      # 8-byte Folded Reload
	sh	a0, 532(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 56(a0)                      # 8-byte Folded Reload
	sh	a0, 534(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 48(a0)                      # 8-byte Folded Reload
	sh	a0, 536(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 40(a0)                      # 8-byte Folded Reload
	sh	a0, 538(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 32(a0)                      # 8-byte Folded Reload
	sh	a0, 540(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 24(a0)                      # 8-byte Folded Reload
	sh	a0, 542(a1)
	lui	a0, 1
	add	a0, sp, a0
	...
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, 0(a0)                       # 8-byte Folded Reload
	sh	a0, 548(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -8(a0)                      # 8-byte Folded Reload
	...
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -152(a0)                    # 8-byte Folded Reload
	sh	a0, 586(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -160(a0)                    # 8-byte Folded Reload
	sh	a0, 588(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -168(a0)                    # 8-byte Folded Reload
	sh	a0, 590(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -176(a0)                    # 8-byte Folded Reload
	sh	a0, 592(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -184(a0)                    # 8-byte Folded Reload
	sh	a0, 594(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -192(a0)                    # 8-byte Folded Reload
	sh	a0, 596(a1)
	lui	a0, 1
	add	a0, sp, a0
	ld	a0, -200(a0)                    # 8-byte Folded Reload
	sh	a0, 598(a1)
	...
	ld	a0, -232(a0)                    # 8-byte Folded Reload
	sh	a0, 6(a1)
	.loc	1 11 4 epilogue_begin is_stmt 0 # k135114294390320.py:11:4
	lui	a0, 1
	addi	a0, a0, 1968
	add	sp, sp, a0
	.cfi_def_cfa_offset 2032
...
.Ltmp1:
.Lfunc_end0:
	.size	triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9, .Lfunc_end0-triton_poi_fused__scaled_dot_product_flash_attention_for_cpu__to_copy__unsafe_view_add_bmm_cat_clone_expand_le_mul_scalar_tensor_transpose_unsqueeze_view_where_9
	.cfi_endproc
                                        # -- End function
...
.Linfo_string1:
	.asciz	"k135114294390320.py"           # string offset=7 ; k135114294390320.py
.Linfo_string2:
