...
.Lfunc_begin0:
	...
	.cfi_startproc
# %bb.0:
	.file	1 "/home/chlee/qwen_triton_engine/rebuilt_kernels" "k135112023920880.py"
	.loc	1 7 19 prologue_end             # k135112023920880.py:7:19
	lw	a2, 4(a0)
	lwu	a0, 0(a0)
	slli	a2, a2, 32
	or	a0, a2, a0
	.loc	1 10 18                         # k135112023920880.py:10:18
	addi	a0, a0, 1
	.loc	1 11 85                         # k135112023920880.py:11:85
	srli	a2, a0, 32
	sw	a0, 0(a1)
	sw	a2, 4(a1)
	.loc	1 11 4 is_stmt 0                # k135112023920880.py:11:4
	ret
.Ltmp0:
.Lfunc_end0:
...
.Linfo_string1:
	.asciz	"k135112023920880.py"           # string offset=7 ; k135112023920880.py
.Linfo_string2:
