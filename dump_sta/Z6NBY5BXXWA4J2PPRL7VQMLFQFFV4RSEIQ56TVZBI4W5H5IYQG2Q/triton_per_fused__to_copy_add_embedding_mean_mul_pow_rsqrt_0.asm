...
.Lfunc_begin0:
	.file	1 "/home/chlee/qwen_triton_engine/rebuilt_kernels" "k135114448388640.py"
	.loc	1 2 0                           # k135114448388640.py:2:0
...
# %bb.0:
	...
	mul	a4, a4, a5
	sub	sp, sp, a4
	.cfi_escape 0x0f, 0x0e, 0x72, 0x00, 0x11, 0x10, 0x22, 0x11, 0x98, 0x02, 0x92, 0xa2, 0x38, 0x00, 0x1e, 0x22 # sp + 16 + 280 * vlenb
.Ltmp0:
	.loc	1 17 19 prologue_end            # k135114448388640.py:17:19
	lw	a5, 4(a0)
	lwu	a6, 0(a0)
	li	a0, 64
	li	a4, 32
	slli	a5, a5, 32
	or	a5, a5, a6
	.loc	1 21 48                         # k135114448388640.py:21:48
	slli	a6, a5, 8
	slli	a5, a5, 11
	sub	a5, a5, a6
	add	a1, a5, a1
	...
	.loc	1 21 102 is_stmt 0              # k135114448388640.py:21:102
	...
	addi	a5, a5, 16
	vs8r.v	v8, (a5)                        # vscale x 64-byte Folded Spill
	.loc	1 21 102                        # k135114448388640.py:21:102
	vsetvli	zero, a4, e32, m8, ta, ma
	vzext.vf2	v8, v0
	vsll.vi	v16, v8, 16
	csrr	a5, vlenb
	...
	.loc	1 23 18 is_stmt 1               # k135114448388640.py:23:18
	vfmul.vv	v8, v8, v8
.Ltmp1:
	.file	2 "/home/chlee/triton-cpu/python/triton/language" "standard.py"
	.loc	2 263 15                        # standard.py:263:15 @[ standard.py:293:36 @[ k135114448388640.py:26:24 ] ]
	vfmacc.vv	v8, v16, v16
.Ltmp2:
	.loc	1 23 18                         # k135114448388640.py:23:18
	vfmul.vv	v16, v0, v0
.Ltmp3:
	.loc	2 263 15                        # standard.py:263:15 @[ standard.py:293:36 @[ k135114448388640.py:26:24 ] ]
...
.Ltmp9:
	...
	vfmacc.vv	v0, v8, v8
.Ltmp10:
	.loc	1 25 35                         # k135114448388640.py:25:35
	vmv.v.i	v8, 0
	csrr	a5, vlenb
	slli	a5, a5, 8
	add	a5, sp, a5
...
.Ltmp25:
	...
	vfadd.vv	v8, v16, v8
.Ltmp26:
	.loc	2 293 36                        # standard.py:293:36 @[ k135114448388640.py:26:24 ]
...
.Ltmp33:
	...
	vfadd.vv	v8, v8, v16
.Ltmp34:
	.loc	1 26 27                         # k135114448388640.py:26:27
	...
	lui	a1, 280064
	fmv.w.x	fa5, a1
	.loc	1 28 20                         # k135114448388640.py:28:20
	vfdiv.vf	v8, v8, fa5
	lui	a1, 219235
	addi	a1, a1, 1981
	fmv.w.x	fa5, a1
	.loc	1 30 20                         # k135114448388640.py:30:20
	vfadd.vf	v8, v8, fa5
	.loc	1 31 28                         # k135114448388640.py:31:28
	vfsqrt.v	v8, v8
	.loc	1 32 19                         # k135114448388640.py:32:19
	vfmv.f.s	fa5, v8
	lui	a1, 260096
	fmv.w.x	fa4, a1
	fdiv.s	fa5, fa4, fa5
	.loc	1 19 38                         # k135114448388640.py:19:38
	addi	a1, a2, 1536
	vsetvli	zero, a0, e16, m8, ta, ma
	vle16.v	v8, (a1)
	.loc	1 19 92 is_stmt 0               # k135114448388640.py:19:92
	vsetvli	zero, a4, e32, m8, ta, ma
	vzext.vf2	v16, v8
	vsll.vi	v16, v16, 16
	csrr	a1, vlenb
	...
	addi	a1, a1, 16
	vl8r.v	v24, (a1)                       # vscale x 64-byte Folded Reload
	.loc	1 32 19 is_stmt 1               # k135114448388640.py:32:19
	vfmul.vf	v24, v24, fa5
	.loc	1 34 20                         # k135114448388640.py:34:20
	...
	vsetvli	zero, a0, e16, m8, ta, ma
	vle16.v	v8, (a1)
	.loc	1 19 92                         # k135114448388640.py:19:92
	vsetvli	zero, a4, e32, m8, ta, ma
	vsll.vi	v16, v16, 16
	csrr	a1, vlenb
	li	a5, 216
	...
	vsetvli	zero, a4, e32, m8, ta, ma
	vzext.vf2	v16, v8
	.loc	1 19 38 is_stmt 0               # k135114448388640.py:19:38
	vsetvli	zero, a0, e16, m8, ta, ma
	vle16.v	v8, (a2)
	.loc	1 19 92                         # k135114448388640.py:19:92
	vsetvli	zero, a4, e32, m8, ta, ma
	...
	.loc	1 34 20                         # k135114448388640.py:34:20
	vfmul.vv	v8, v0, v8
	.loc	1 35 76                         # k135114448388640.py:35:76
	...
	vl8r.v	v8, (a1)                        # vscale x 64-byte Folded Reload
	vse16.v	v8, (a0)
	.loc	1 35 4 epilogue_begin is_stmt 0 # k135114448388640.py:35:4
	csrr	a0, vlenb
	li	a1, 280
	mul	a0, a0, a1
	add	sp, sp, a0
...
.Linfo_string1:
	.asciz	"k135114448388640.py"           # string offset=7 ; k135114448388640.py
.Linfo_string2:
