	...
	.text
	.globl	triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5 # -- Begin function triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5
	.p2align	2
	.type	triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5,@function
triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5: # @triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5
.Lfunc_begin0:
	.file	1 "/home/chlee/qwen_triton_engine/rebuilt_kernels" "k135114449663360.py"
	.loc	1 2 0                           # k135114449663360.py:2:0
...
# %bb.0:
	...
	mv	s5, a4
.Ltmp0:
	.loc	1 4 33 prologue_end             # k135114449663360.py:4:33
	slliw	a7, a6, 7
	li	s3, 32
	li	s4, 64
	li	a5, 96
	li	a6, 128
	.loc	1 5 23                          # k135114449663360.py:5:23
	vsetvli	zero, s3, e32, m8, ta, ma
	vid.v	v8
	.loc	1 12 30                         # k135114449663360.py:12:30
	slli	a4, a7, 1
	.loc	1 5 23                          # k135114449663360.py:5:23
	vor.vx	v16, v8, a7
	csrr	t0, vlenb
	...
	.loc	1 12 35                         # k135114449663360.py:12:35
	addi	a5, a1, 128
	.loc	1 6 21                          # k135114449663360.py:6:21
	vmslt.vx	v16, v0, a6
	csrr	t0, vlenb
	li	t1, 56
	mul	t0, t0, t1
	...
	addi	t1, t1, -1344
	add	t0, t0, t1
	vs1r.v	v17, (t0)                       # vscale x 8-byte Folded Spill
	vmv1r.v	v0, v16
	...
	addi	t0, t0, -1344
	add	a6, a6, t0
	vs1r.v	v16, (a6)                       # vscale x 8-byte Folded Spill
	vmv1r.v	v24, v17
	.loc	1 12 35                         # k135114449663360.py:12:35
	...
	vsetvli	zero, s3, e32, m8, ta, ma
	vmv.v.x	v24, a7
	.loc	1 9 19                          # k135114449663360.py:9:19
	vsra.vi	v24, v24, 31
	csrr	a1, vlenb
	li	a7, 80
	mul	a1, a1, a7
	...
	.loc	1 13 37                         # k135114449663360.py:13:37
	vsrl.vi	v24, v24, 27
	csrr	a1, vlenb
	li	a7, 152
	mul	a1, a1, a7
	...
	vand.vx	v24, v24, a6
	vsub.vv	v24, v0, v24
	.loc	1 12 45                         # k135114449663360.py:12:45
	vzext.vf2	v0, v8
	csrr	a1, vlenb
	li	a7, 48
	mul	a1, a1, a7
	...
	.loc	1 13 43                         # k135114449663360.py:13:43
	...
	.loc	1 10 19                         # k135114449663360.py:10:19
	lw	a1, 4(a0)
	lwu	a0, 0(a0)
	.loc	1 13 43                         # k135114449663360.py:13:43
	vsetvli	zero, s3, e32, m8, ta, ma
	...
	vand.vx	v24, v24, a6
	vsub.vv	v24, v0, v24
	.loc	1 22 20                         # k135114449663360.py:22:20
	fcvt.s.l	fa5, s11
	.loc	1 23 20                         # k135114449663360.py:23:20
	...
	add	a0, a0, a7
	vl8r.v	v24, (a0)                       # vscale x 64-byte Folded Reload
	.loc	1 13 37 is_stmt 0               # k135114449663360.py:13:37
	vadd.vv	v24, v0, v24
	vand.vx	v24, v24, a6
	vsub.vv	v0, v0, v24
	csrr	a0, vlenb
	...
	.loc	1 23 20 is_stmt 1               # k135114449663360.py:23:20
	vfmul.vf	v16, v16, fa5
	csrr	a0, vlenb
	li	a7, 144
	mul	a0, a0, a7
	...
	.loc	1 9 19 is_stmt 1                # k135114449663360.py:9:19
	vsrl.vi	v8, v8, 26
	csrr	a2, vlenb
	li	a5, 112
	mul	a2, a2, a5
	...
	add	a2, a2, a5
	vs8r.v	v8, (a2)                        # vscale x 64-byte Folded Spill
	.loc	1 8 19                          # k135114449663360.py:8:19
	vand.vx	v8, v8, a0
	vsub.vv	v8, v0, v8
	csrr	a0, vlenb
	li	a2, 80
	...
	.loc	1 14 31                         # k135114449663360.py:14:31
	add	a3, a3, a4
	.loc	1 14 36 is_stmt 0               # k135114449663360.py:14:36
	addi	a0, a3, 128
	csrr	a2, vlenb
	li	a4, 88
	mul	a2, a2, a4
	...
	vsetvli	zero, s4, e16, m8, ta, mu
	vmv.v.i	v24, 0
	.loc	1 14 36                         # k135114449663360.py:14:36
	vmv.v.i	v8, 0
	csrr	a2, vlenb
	li	a4, 72
	mul	a2, a2, a4
	...
	addi	a2, a2, -1344
	add	a0, a0, a2
	vl1r.v	v25, (a0)                       # vscale x 8-byte Folded Reload
	.loc	1 6 21                          # k135114449663360.py:6:21
	...
	add	a0, a0, a2
	vs8r.v	v16, (a0)                       # vscale x 64-byte Folded Spill
	.loc	1 14 46                         # k135114449663360.py:14:46
	vsetvli	zero, s3, e16, m8, ta, ma
	...
	addi	a0, a0, -856
	add	s8, sp, a0
	.loc	1 20 32                         # k135114449663360.py:20:32
	srliw	a0, a1, 31
	slli	a0, a0, 7
	csrr	a1, vlenb
	li	a2, 40
	...
	add	a1, a1, a2
	vl8r.v	v8, (a1)                        # vscale x 64-byte Folded Reload
	.loc	1 24 24                         # k135114449663360.py:24:24
	vse32.v	v8, (a0)
	flw	fa0, 84(s9)
	...
	.loc	1 27 24                         # k135114449663360.py:27:24
	call	sinf
	fsw	fa0, 1236(s9)
	...
	add	a0, a0, a1
	vl8r.v	v16, (a0)                       # vscale x 64-byte Folded Reload
	.loc	1 29 20                         # k135114449663360.py:29:20
	vfmul.vv	v0, v8, v16
	csrr	a0, vlenb
	li	a1, 40
	mul	a0, a0, a1
	...
	add	a0, a0, a1
	vl8r.v	v16, (a0)                       # vscale x 64-byte Folded Reload
	.loc	1 30 20                         # k135114449663360.py:30:20
	vfmacc.vv	v0, v8, v16
	csrr	a0, vlenb
	slli	a0, a0, 7
	add	a0, sp, a0
	...
	.loc	1 30 20                         # k135114449663360.py:30:20
	vfmacc.vv	v24, v8, v16
	.loc	1 31 57                         # k135114449663360.py:31:57
	...
	add	a0, a0, a1
	vs8r.v	v0, (a0)                        # vscale x 64-byte Folded Spill
	.loc	1 31 33 is_stmt 0               # k135114449663360.py:31:33
	slli	s11, s11, 6
	csrr	a0, vlenb
	li	a1, 56
	mul	a0, a0, a1
	...
	add	a0, a0, a1
	vl8r.v	v8, (a0)                        # vscale x 64-byte Folded Reload
	.loc	1 31 45                         # k135114449663360.py:31:45
	vsetvli	zero, s3, e32, m8, ta, ma
	vsll.vi	v8, v8, 7
	lui	a2, 1048574
	lui	a0, 4
	...
	add	a2, a2, a3
	vl8r.v	v0, (a2)                        # vscale x 64-byte Folded Reload
	.loc	1 31 30                         # k135114449663360.py:31:30
	vsetivli	zero, 16, e32, m4, ta, ma
	vwadd.vv	v8, v0, v16
	.loc	1 31 40                         # k135114449663360.py:31:40
...
.LBB0_11:                               # %cond.store19
	.loc	1 0 57                          # k135114449663360.py:0:57
	csrr	a0, vlenb
	li	a1, 144
	mul	a0, a0, a1
	add	a0, sp, a0
...
.LBB0_12:                               # %else20
	...
	add	a0, a0, a1
	vl8r.v	v8, (a0)                        # vscale x 64-byte Folded Reload
	.loc	1 31 0                          # k135114449663360.py:31
	vsetivli	zero, 16, e32, m8, ta, ma
...
.LBB0_164:                              # %cond.store253
	...
	sh	a1, 0(a0)
.LBB0_165:                              # %else254
	.loc	1 31 4 epilogue_begin           # k135114449663360.py:31:4
	addi	sp, s0, -2032
	.cfi_def_cfa sp, 2032
...
.LBB0_166:                              # %cond.store
	.cfi_restore_state
	.loc	1 0 4                           # k135114449663360.py:0:4
	csrr	a0, vlenb
	li	a1, 144
	mul	a0, a0, a1
	add	a0, sp, a0
...
.Ltmp1:
.Lfunc_end0:
	.size	triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5, .Lfunc_end0-triton_poi_fused__to_copy_add_arange_bmm_cat_expand_index_copy_mul_transpose_unsqueeze_view_5
	.cfi_endproc
                                        # -- End function
...
.Linfo_string1:
	.asciz	"k135114449663360.py"           # string offset=7 ; k135114449663360.py
.Linfo_string2:
